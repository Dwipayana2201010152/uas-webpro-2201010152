...
$query = mysqli_query($conn, "SELECT tb_order.*,nama, SUM(harga*jumlah) AS harganya FROM tb_order
    ...
    LEFT JOIN tb_daftarmenu ON tb_daftarmenu.id = tb_list_order.menu
    GROUP BY id_order");
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_edit_order.php" method="POST">
                                    <input readonly type="hidden" value="<?php echo $row['id_order'] ?>" name="id">
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="uploadfoto" name="kode_order" value="<?php echo $row['id_order'] ?>">
                                                <label for="uploadfoto">Kode Order</label>
                                                <div class="invalid-feedback">
                                                    Masukkan Kode Order
                                                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $row['id_order'] ?>"><i class="bi bi-trash"></i></i></button>
                                    </div>
                                </td>
                            </tr>
                        <?php

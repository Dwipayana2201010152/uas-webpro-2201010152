...
<div class="col-lg-9 mt-2">
    <div class="card">
        ...
        <div class="card-body">
            <a href="order" class="btn btn-info mb-3"><i class="bi bi-arrow-bar-left"></i>Back</a>
            <div class="row">
                <div class="col-lg-3">
                                                    ...
                                                    <select disabled class="form-select" aria-label="Default select example">
                                                        ...
                                                        foreach ($select_kat_menu as $value) {
                                                            if ($row['kategori'] == $value['id_kat_menu']) {
                                                                echo "<option selected value=" . $value['id_kat_menu'] . ">$value
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <button class="btn btn-danger btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $row['id_order'] ?>"><i class="bi bi-trash"></i></i></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
